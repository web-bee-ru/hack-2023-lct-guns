...
num_classes = len(os.listdir(config.TRAIN))
...
feature_extract = config.FINETUNE_PRETRAINED
...
def initialize_model(model_name, num_classes, feature_extract, use_pretrained=True):
    """
    Initialize model and sets parameters due to selected model
    """
...
if __name__ == "__main__":
    ...
    for model_name in [
        ...
        print(f"[{model_name}] Start training new model...", end="\n\n")
